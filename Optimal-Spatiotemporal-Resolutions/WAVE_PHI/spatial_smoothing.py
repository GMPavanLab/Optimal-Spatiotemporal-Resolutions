...
# EXAMPLE
cutoff = 200
name = "wave_PHI_cutoff_200A.npy"
array = f"wave_SP_200/{name}"
u = mda.Universe("wave_SP_13.5/onda.gro", "wave_SP_13.5/onda.xtc")
sp_array = spatial_smoothing(u, array, "type C", cutoff,0, 8)
print(sp_array)
np.savez(f"sp_{cutoff}_{name}.npz",sp_array)
